...
<body>
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        // Query untuk mengambil data penjualan yang diterima (terima = 1) dalam rentang tanggal
        $sql = "SELECT * FROM produksi WHERE terima = 1 AND tanggal BETWEEN '$date1' AND '$date2'";
        $result = $conn->query($sql);

        // Variabel untuk nomor urut dan total qty
        $no = 1;
        $total = 0;
        ...
        <tfoot>
            <tr>
                <td colspan="3" style="text-align: right;"><b>Total Jumlah Terjual:</b></td>
                <td><b><?= $total; ?></b></td>
            </tr>
        </tfoot>
    </table>
